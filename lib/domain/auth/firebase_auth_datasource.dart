...
import 'package:todo_note_app/data/mappers/auth_mappers.dart';
import 'package:todo_note_app/data/models/auth_model.dart';
import 'package:todo_note_app/domain/auth/auth_datasource.dart';
...
class FirebaseAuthDataSource extends AuthDataSource {
  ...
  Future<UserModel> getUserModel() async {
    ...
    await userLogOut();
    throw LoadDataException(message: 'Hubo un error al cargar los datos, inicie sesión de nuevo', code: 400);
  }
