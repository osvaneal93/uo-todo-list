...
import 'package:todo_note_app/domain/auth/auth_repository.dart';
import 'package:todo_note_app/domain/auth/firebase_auth_datasource.dart';

final authStateProvider = StateNotifierProvider<AuthStateProvider, AuthState>((ref) {
  final authRepository = AuthRepository(FirebaseAuthDataSource(FirebaseAuth.instance));
